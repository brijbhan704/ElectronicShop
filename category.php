	...
	<div class="product">		
		<div class="product-image">
			<div class="image hovereffect">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="100" height="200"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<i class="fa fa-inr"> </i> <?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount"><i class="fa fa-inr"> </i><?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
