...
popUpWin = open(URLStr,'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+400+',height='+400+',left='+300+', top='+100+',screenX='+300+',screenY='+100+'');
...
?>
 ...
 -->
							...
							<td><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Track</button></td>
  ...
  <div id="demo" class="collapse">
    ...
    <table class="table table-bordered" style="width: 67%; margin-left: 190px; margin-top: 30px;">
    	<thead>
    <tr>
...
<?php } } 
   ...
   ?> 
   <tr>
   <td colspan="2"><b>Order Not Process Yet</td>
   </tr> 
   <?php  }
   $st='Delivered';
   $rt = mysqli_query($con,"SELECT * FROM orders WHERE id='$orderid'");
   ...
   <tr><td></td><td></td><td><b>
      Product Delivered successfully </b></td><td></td>
    </tr>
    <?php
}
?>
